...
function Footer() {
    return (
        ...
        <div class="mx-[6%] px-4 md:px-0 md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-8 sm:gap-6 ">
                <div>
                ...
                <div>
                    ...
                    <ul class="text-gray-600">
                        <li class="mb-4">
                            <a href="https://github.com/RagoDevs" class="hover:underline ">Github</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="mx-[6%] px-4 md:px-0 sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="https://github.com/RagoDevs" class="text-gray-500 hover:text-gray-900">
